          ...
          <div className="flex flex-wrap gap-4 items-end">
            ...
            <div>
              ...
              <select
                ...
                className="border border-slate-200 rounded-xl px-3 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 bg-white min-w-[140px]"
              >
                    ...
                    <tbody>
                      {breakdown.map((d) => (
                        <tr key={d[breakdownKey]} className="border-b border-slate-50 hover:bg-slate-50/50">
                          ...
                          <td className="px-6 py-3 font-bold text-blue-600">{formatETB(d.revenue)}</td>
                        </tr>
                      ))}
                      <tr className="bg-slate-50 font-bold">
                        ...
                        <td className="px-6 py-3 text-blue-600">{formatETB(summary.total_revenue)}</td>
                      </tr>
                    </tbody>
                  </table>
                )}
...
function StatCard({ label, value, accent }) {
  return (
    <div className="bg-white border border-slate-200/80 rounded-2xl p-5 shadow-sm hover:shadow-md transition-shadow">
      ...
      <p className={`text-2xl font-black mt-2 tabular-nums ${accent ? 'text-blue-600' : 'text-slate-800'}`}>{value}</p>
    </div>
  );
}
