...
export function ActiveParkingCard({ session, bayNumber }) {
  ...
  return (
    <div className="group relative bg-white rounded-2xl border-2 border-neutral-200 shadow-md hover:shadow-xl hover:border-blue-300 hover:-translate-y-0.5 transition-all duration-300 overflow-hidden">
      <div className="flex items-center justify-between px-4 py-2.5 bg-neutral-950 text-white">
        <div className="flex items-center gap-2">
          {logoUrl ? (
            ...
            <span className="w-6 h-6 rounded-md bg-blue-600 flex items-center justify-center text-[10px] font-black">P</span>
          )}
          <div>
        ...
        <span className="flex items-center gap-1.5 text-[10px] font-bold uppercase tracking-wider text-blue-400">
          <span className="w-2 h-2 rounded-full bg-blue-400 live-pulse" />
          Occupied
        </span>
      </div>
      ...
      <div className="px-4 pt-4 pb-4">
        ...
        <div className="mt-3 flex items-center justify-between rounded-xl bg-gradient-to-r from-slate-900 to-slate-800 px-4 py-3">
          ...
          <span className="text-xl font-black text-blue-400 tabular-nums">{formatETB(session.running_fee)}</span>
        </div>
      </div>
    ...
    <div className="col-span-full">
      <div className="rounded-2xl overflow-hidden border-2 border-dashed border-neutral-300 bg-white">
        <div className="parking-lot-floor px-6 py-4 flex items-center justify-between">
          ...
          <span className="text-blue-400 text-xs font-bold uppercase tracking-wider">0 / Open</span>
        </div>
