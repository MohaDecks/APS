  ...
  return (
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex lg:w-[52%] relative overflow-hidden airport-grid-bg text-white flex-col justify-between p-12">
        <div className="absolute inset-0 bg-gradient-to-br from-neutral-950/95 via-blue-950/70 to-neutral-900/90" />
        <div className="absolute -top-24 -right-24 w-80 h-80 rounded-full bg-blue-500/10 blur-3xl" />
        <div className="absolute bottom-20 -left-16 w-64 h-64 rounded-full bg-blue-600/10 blur-3xl" />
        ...
        <div className="relative flex flex-col items-start">
          ...
          <p className="text-slate-400 mt-4 max-w-sm text-base leading-relaxed">
            Monitor live parking bays, track revenue, and manage operator accounts for {branding.facilityName || 'Bildhaan Parking'}.
          </p>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              <div>
                ...
                <input
                  ...
                  className="w-full border border-slate-200 rounded-xl px-4 py-3 text-sm bg-slate-50 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-shadow"
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full btn-primary py-3.5 text-sm font-bold shadow-lg shadow-blue-900/20"
              >
