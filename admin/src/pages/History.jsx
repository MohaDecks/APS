          ...
          <div className="flex-1 min-w-[200px]">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full border border-slate-200 rounded-xl pl-10 pr-3 py-2.5 text-sm uppercase font-mono focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
              />
            </div>
          </div>
          <div>
